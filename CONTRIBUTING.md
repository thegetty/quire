...
Quire is currently in closed beta. Please [sign-up for access](https://forms.gle/m1fgZu5BHKhddMrW7). 
...
- Find the [“good first issues”](TK) tagged in our issue tracker
...
- [Issue Tracking](https://github.com/thegetty/quire/issues/)
- [Documentation](TK)
- [Forum](TK)
...
- [**quire**](https://github.com/thegetty/quire): The command-line interface for Quire. Written in JavaScript, it is the heart of Quire, chaining together its various parts into unified commands.
- [**quire-docs**](https://github.com/thegetty/quire-docs): The Quire website, and the central location for issues and discussion forum posts.

## Identify a Contribution to Make

**The first step to any contribution** is to post a new issue or comment on an existing issue [on our issue tracker](https://github.com/thegetty/quire/issues/).
...
All Quire issues should be posted to, and are tracked through, our [central Quire project repository](https://github.com/thegetty/quire). 
...
- [Post a new bug](https://github.com/thegetty/quire/issues/new)
...
- [Volunteer to do some translation](https://github.com/thegetty/quire/issues/new)
...
In Quire, themes contain all of a Quire publication’s key features in templates, shortcodes, styles and scripts. Themes can be complete packages of base styles and features, like [Quire’s starter theme](TK), or can be smaller packages of just one or more features to be layered on top of a base theme.
