  ...
  buildHTML(arr, linksTitles, hashLinks) {
    return new Promise(function (resolve, reject) {
      if (arr === '' || linksTitles === '' || hashLinks === '') {
        ...
        updateHTML.find('.quire-figure--group')
          .each((index, el) => {
            let html = $(el).html()
        ...
        updateHTML.find('a')
          .attr('href', (index, href) => {
            ...
            if (href.indexOf(`empty`) !== -1) {
              ...
              reject(new Error(`Fragment identifier on page ${page} of <a href="#"></a> could not be found. Please correct this and try again.`), null)
            }
