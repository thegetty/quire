...
const CONFIG = {
  ...
  CURRENT_VERSION: 'v0.1.0.alpha.8',
...
class CLI extends EventEmitter {
  ...
  shutdown () {
    ...
    if (this.project.hasOwnProperty('hugo')) {
      this.project.hugo.kill()
    }
    if (this.project.hasOwnProperty('webpack')) {
      this.project.webpack.kill()
    }
    process.exit()
  }
