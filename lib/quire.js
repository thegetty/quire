...
class QuireCLI extends EventEmitter {
  ...
  pdf() {
    this._preflight()
    let sorted = this._pdfChapters()
    // console.log(sorted)
    sorted.forEach(function(chapter) {
      console.log(this._getPathForChapter(chapter))
    })
  }
  ...
  _getPathForChapter(chapter) {
    // TODO: Figure out how to get the output path for a given chapter
    // This will depend on page permalink, Hugo config settings, etc.
  }
