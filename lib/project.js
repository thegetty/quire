    ...
    try {
      ...
      if (ready) {
        ...
        if (dirCreated) {
          ...
          execSync(`pandoc ${args}`);
          const kindlegenCmd = this.isWin() ? "C:\\Program Files (x86)\\Kindle Previewer 3\\lib\\fc\\bin\\kindlegen" : "/Applications/Kindle Previewer 3.app/Contents/lib/fc/bin/kindlegen";
