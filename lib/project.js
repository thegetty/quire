    ...
    this.buildTheme()
      ...
      .then((output, server) => {
        ...
        bookData.chapters = _
          ...
          console.log(bookData, configData)
 ...
 */
  buildPDCEpub(fileName, filePath, env) {
    console.log(`filename: ${fileName} env: ${env}`)
    ...
    .then((output, server) => {
      ...
      let src = data
      let args = `--css=epub.css -o ./static/downloads/${fileName}.epub`
      console.log(src)
      execSync(`pandoc ${src} ${args}`)
