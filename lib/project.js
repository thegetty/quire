...
class Project extends EventEmitter {
   ...
   */
  buildEpub () {
    // TODO: Instantiate a new Epub object and pass the relevent data to it
    // (bookData from publication.yml and chapters).
    ...
    bookData.chapters = epubChapters
    let ebook = new Epub(bookData)
    console.log(ebook)

    // let hugo = spawn('hugo', ['server'])

    // Move this logic inside the epub class...
    // this.buildTheme()
