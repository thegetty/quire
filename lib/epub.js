...
class Epub extends EventEmitter {
  ...
  creators () {
    ...
    let creators = _.castArray(this.data.contributor)
    return creators.filter((contributor) => {
  ...
  contributors () {
    ...
    let contributors = _.castArray(this.data.contributor)
    return contributors.filter((contributor) => {
      if (contributor.type !== "secondary-contributor") {
        return false
      }
      let name = contributor.full_name || `${contributor.first_name} ${contributor.last_name}`
      return {
