...
class Chapter {
  ...
  pandocTitle(title) {
    title = title !== this.epubTitle ? title.replace(/[^a-zA-Z0-9 ]/g, ' ') : title.replace(/[^a-zA-Z0-9.]/g, ' ')
    let t = title
  ...
  reformatPage() {
    ...
    */
    ...
    function reformatLinks() {
      ...
      chapter.links
        ...
        .attr('href', (index, href) => {
          ...
          if (href.indexOf('fn-') !== -1 || href.indexOf('fnref-') !== -1) {
            hrefArr.push({ 'footnoteInternalLinks': `#${href}-${chapter.pandocTitle(chapter.chapterId)}` })
      ...
      // Reformat any internal links that start with numbers
      chapter.links
        .filter(function (i, el) {
          return chapter.attrMatches(el, 'href', /^#[\d]+/)
        })
        .attr('href', (index, href) => {
          hrefArr.push({ 'numberInternalLinks': `#${href}-${chapter.pandocTitle(chapter.chapterId)}` })
          return `${href}-${chapter.pandocTitle(chapter.chapterId)}`
        })
